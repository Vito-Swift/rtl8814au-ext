...
#include "../hal/rtl8814a/rtl8814a_bf_monitor.h"
#endif
...
} INTERFACE_SELECT_USB,
	*PINTERFACE_SELECT_USB;
...
#define HAL_SPEC_CHK_RF_PATH(_spec, _band, _path) (                                                                             \
	_band == BAND_ON_2_4G ? HAL_SPEC_CHK_RF_PATH_2G(_spec, _path) : _band == BAND_ON_5G ? HAL_SPEC_CHK_RF_PATH_5G(_spec, _path) \
																						: 0)
...
#if defined(CONFIG_RTL8723B) || defined(CONFIG_RTL8703B) || defined(CONFIG_RTL8188F) || defined(CONFIG_RTL8188GTV) || defined(CONFIG_RTL8723D) || defined(CONFIG_RTL8192F)
