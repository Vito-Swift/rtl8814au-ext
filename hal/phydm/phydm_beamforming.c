					   ...
					   u8 *my_mac_addr)
{
	...
	{
		if (cmn_sta->support_wireless_set & WIRELESS_HT)
		{ /*@HT*/
			if (TEST_FLAG(sta->cur_beamform, BEAMFORMING_HT_BEAMFORMER_ENABLE))
		...
		{ /*VHT*/
			...
			if (phydm_acting_determine(dm, phydm_acting_as_ap))
			{ /* Only AP mode supports to act an MU beamformer */
